...
4) Spring security in website for end user authentication
5) Resource server is not required in web site because resources are in microservices but not in website.
