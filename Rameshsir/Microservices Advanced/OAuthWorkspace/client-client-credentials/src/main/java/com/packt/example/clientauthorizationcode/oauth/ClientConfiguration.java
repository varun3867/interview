...
public class ClientConfiguration {
    ...
    public OAuth2ProtectedResourceDetails resourceDetails() {
        ...
        //resourceDetails.setUserAuthorizationUri("http://localhost:9090/oauth/authorize"); //remove
        resourceDetails.setAccessTokenUri("http://localhost:9090/oauth/token");
        resourceDetails.setScope(Arrays.asList("read_profile"));
        //resourceDetails.setPreEstablishedRedirectUri(("http://localhost:9000/callback")); //remove
        //resourceDetails.setUseCurrentUri(false); //remove
